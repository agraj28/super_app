import 'dart:async';
import 'package:super_app/src/ui_modules/App.dart';
import 'package:super_app_framework/super_app_framework.dart';
import 'package:flutter/material.dart';
import 'package:page_transition/page_transition.dart';
import 'package:super_app_framework/super_app_framework.dart';
import '../../services/system_navigator/helper/navigator_helper.dart' as navigator_helper;
...
class NavigatorService {
  ...
  void push(EnumPageIntent? pageIntent, dynamic pageModel,
    ...
    // First set the Modal to act on
    _enableModalLayer.add(isModal);
    if (isModal) {
    ...
    // For the Modal screen type, simply push the page on the modal key
    if (isModal) {
      // Get the Widget to display
      var pageToDisplay = getWidgetToDisplay(pageModel,
          pageIntent: pageIntent ?? EnumPageIntent.DefaultPage);

      performOperation(EnumTransitionType.Push, navigatorKey, pageToDisplay,
  ...
  GlobalKey<NavigatorState>? _getNavigatorKey() {
    ...
    return navigator_helper.navigatorKeys[NavigationDomains.App];
  }
}
